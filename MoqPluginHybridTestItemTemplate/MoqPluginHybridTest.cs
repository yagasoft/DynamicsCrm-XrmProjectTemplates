...
namespace $rootnamespace$
{
	...
	/// </summary>
	[TestClass]
	public class $safeitemrootname$ : PluginHybridTest
	{
		...
		private void Setup$safeitemrootname$Test()
		{
			...
			// TODO: add pre and post images (added to the context in the plugin object)
			//AddPreImage("ticket", ticket);

			// TODO: target record for the plugin to use (added to the context in the plugin object)
			SetTarget(/*ticket*/);
		}
